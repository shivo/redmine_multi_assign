...
Just go to vendor/plugins directory and clone this projects from github:
...
This plugin was tested for quite a long time in production environment in our company.
But this does not mean its bug free. Use with care!
